...
//        colTanggal.setCellFactory(col -> new TableCell<Transaksi, String>() {
...
//                    if (transaksi.getCreatedAt() != null) {
//                        setText(transaksi.getCreatedAt().toLocalDateTime().format(formatter));
//                    }
//                }
//            }
//        });
...
//        Long idKasir = SessionManager.getCurrentUser().getIdUser();
